...
while (circle)
{
    ...
    {
        Console.WriteLine("For matrix multiplication, the number of columns in the first matrix must be equal to the number of rows in the second matrix. Retype new numbers.");
        continue;
    } 
}
